...
const mapNode = (n) => ({
  ...
  data: {
    ...
    tempAmbiance: n.temp_ambiance ?? null,
    tempEffect: n.temp_effect ?? null,
    tempImageUrl: n.temp_image_url ?? null,
    isNodeTempCustom: !!n.is_node_temp_custom,
    isNodeImg: !!n.is_node_img,
  },
